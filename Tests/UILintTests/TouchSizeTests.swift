...
class TouchSizeTests: XCTestCase {
    ...
    func testUIButtonMinimumHeight() {
        ...
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIButton width/height is less than 44pt (44.0,43.0)" )
    ...
    func testUIButtonMinimumWidth() {
        ...
        let findings = lint!.findings
        XCTAssertEqual(findings.count, 1)
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIButton width/height is less than 44pt (43.0,44.0)" )
        XCTAssertEqual(findings[0].severity, .error)
    }
    ...
    func testUIButtonMinimumWidthAndHeight() {
        ...
        let findings = lint!.findings
        XCTAssertEqual(findings.count, 1)
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIButton width/height is less than 44pt (1.0,1.0)" )
        XCTAssertEqual(findings[0].severity, .error)
    }
    ...
    func testUIButtonZeroSize() {
        ...
        let findings = lint!.findings
        XCTAssertEqual(findings.count, 1)
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIButton width/height is less than 44pt (0.0,0.0)" )
        XCTAssertEqual(findings[0].severity, .error)
    }
    ...
    func testUIViewGRMinimumHeight() {
        ...
        let findings = lint!.findings
        XCTAssertEqual(findings.count, 1)
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIView width/height is less than 44pt (44.0,43.0)" )
        XCTAssertEqual(findings[0].severity, .error)
    }
    ...
    func testUIViewGRMinimumWidth() {
        ...
        let findings = lint!.findings
        XCTAssertEqual(findings.count, 1)
        XCTAssertEqual(findings[0].message, "Provide ample touch targets for interactive elements. UIView width/height is less than 44pt (43.0,44.0)" )
        XCTAssertEqual(findings[0].severity, .error)
    }
